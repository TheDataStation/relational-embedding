...
proNE_embedding_storage = '../ProNE/emb/'
...
def evaluate_task(args):
    ...
    if args.embedding is not None:
        ...
        all_embeddings_path = EU.all_files_in_path(proNE_embedding_storage, args.task)
    ...
    for path in all_embeddings_path:
        ...
        x_vec = pd.DataFrame(EU.vectorize_df(df_textified, model, model_type = "proNE"))
