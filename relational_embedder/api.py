...
import word2vec
from relational_embedder import old_composition
...
def init(path_to_row_we_model, path_to_col_we_model, path_to_relations):
    ...
    st = time.time()
    row_relemb, col_relemb = old_composition.compose_dataset(path_to_relations, row_we_model, col_we_model)
    et = time.time()
