...
def parse_args():
    ...
    file_name = args.task if args.suffix == "" else "{}_{}".format(
        args.task, args.suffix)
    args.graph = "../graph/{}/{}.edgelist".format(args.task, file_name)
    args.emb1 = "./emb/{}_sparse.emb".format(file_name)
    args.emb2 = "./emb/{}_spectral.emb".format(file_name)
    return args
...
def main():
    ...
    embeddings_matrix = model.chebyshev_gaussian(
        model.matrix0, features_matrix, args.step, args.mu, args.theta)
    t_3 = time.time()
